...
@section('content')
    <section class="content-header">
      <div class="container-fluid">
        ...
        <div class="add-book">
            <a href="{{route('admin.addnhaxuatban')}}" class="btn btn-primary">Thêm mới nhà xuất bản</a>
        </div>
      </div><!-- /.container-fluid -->
    </section>
      ...
      <div class="card">
        ...
        <div class="card-header">
            ...
            <div class="float-right" style="display:flex">
              ...
              {{$nhaxuatbans->links('vendor.pagination.paginate')}}
            ...
            <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                    @foreach($nhaxuatbans as $nhaxuatban)
                        <tr>
                            <td>{{$nhaxuatban->id}}</td>
                            <td>{{$nhaxuatban->TenNhaXB}}</td>
                            <td>{{$nhaxuatban->GhiChu}}</td>
                            <td class="project-actions text-right">
                                <div style="display: flex">
                                    <div>
                                        <a class="btn btn-info btn-sm" href="{{route('admin.editnhaxuatban', $nhaxuatban->id)}}">
                                    ...
                                    <div style="padding-left:5px">
                                        <form action="{{route('admin.deletenhaxuatban', $nhaxuatban->id)}}" method="POST">
                                            @csrf
    ...
    <script>
        document.getElementById('paginationss').onchange = function() {
            window.location = "{!! $nhaxuatbans->url(1) !!}&pagination=" + this.value; 
        };
